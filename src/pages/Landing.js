...
const Landing = () => {
    ...
    return (
        <motion.div
            ...
            className='bg-green-100 min-h-screen flex justify-center items-center'
        >
            <div className="p-10 flex justify-center items-center">
                ...
                >
                    <h1 className="text-4xl font-bold text-green-900 mb-8">Welcome to GreenThumb Community</h1>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <motion.div
                            ...
                            className="flex flex-col justify-center items-center border border-green-300 rounded-lg p-6"
                        >
                            <h2 className="text-2xl font-semibold text-green-900 mb-4">Key Features:</h2>
                    ...
                    >
                        <button onClick={loginWithPopup} className="bg-green-500 text-white py-3 px-6 rounded-full font-semibold text-lg hover:bg-green-600 transition duration-300 ease-in-out">
                            Join the GreenThumb Community Today
                        </button>
                    </motion.div>
                    <div className="mt-8 text-gray-600 text-sm flex items-center justify-center">
                        Ready to Get Started? <button onClick={loginWithPopup} className="text-green-500 ml-2">Sign Up Now <FiArrowRightCircle className="inline-block text-xl" /></button>
                    </div>
                </motion.div>
            </div>
        </motion.div>
